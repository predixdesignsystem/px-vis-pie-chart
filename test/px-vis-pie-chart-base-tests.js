...
function runBaseTests() {
  px_vis_pie_chart_1 = document.getElementById('px_vis_pie_chart_1');

  suite('Base Automation Tests for px-vis-pie-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-pie-chart fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_pie_chart_1') !== null);
    });
